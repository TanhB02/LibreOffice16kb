...
L.Marker = L.Layer.extend({
    ...
    _updateIconPosition: function () {
        ...
        var posVis = L.Layer.getLayerPositionVisibility(this._latlng, this._icon.getBoundingClientRect(), this._map);
    ...
    _initIcon: function () {
        var options = this.options, classToAdd = 'leaflet-zoom-hide';
