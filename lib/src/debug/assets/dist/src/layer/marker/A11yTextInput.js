...
L.A11yTextInput = L.TextInput.extend({
    ...
    _updateFocusedParagraph: function () {
        ...
        if (this._remoteContent !== undefined) {
            this._setFocusedParagraph(this._remoteContent, this._remotePosition, this._remoteSelectionStart, this._remoteSelectionEnd);
        }
...
//# sourceMappingURL=A11yTextInput.js.map