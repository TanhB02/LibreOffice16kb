...
(function (cool) {
    ...
    var SheetGeometry = /** @class */ (function () {
        ...
        SheetGeometry.prototype.checkMaxIndex = function (sheetGeomJSON, column) {
            /*
            ...
            */
            ...
            var hiddenInfo = column ? sheetGeomJSON.columns.hidden.trim() : sheetGeomJSON.rows.hidden.trim();
            var isFirstHidden = hiddenInfo.indexOf('1') === 0;
            var splitted = hiddenInfo.split(' ');
            var isLastHidden = (splitted.length % 2 === 0 && !isFirstHidden) || (splitted.length % 2 === 1 && isFirstHidden);
            if (splitted.length === 1) {
                if (isFirstHidden)
                    return 0; // All hidden.
                else
                    return parseInt(splitted[0].split(':')[1]); // All visible.
            }
        ...
        SheetGeometry.prototype.setTileGeometryData = function (tileWidthTwips, tileHeightTwips, tileSizePixels, updatePositions) {
            ...
            if (app.map)
                app.map.fire('sheetgeometrychanged');
        };
        ...
        SheetGeometry.prototype.convertToTileTwips = function (simplePoint) {
        ...
        SheetGeometry.prototype.convertRectangleToTileTwips = function (simpleRectangle) {
    ...
    var SheetDimension = /** @class */ (function () {
        ...
        SheetDimension.prototype.getGroupsDataInView = function () {
            ...
            this._outlines.forEachGroupInRange(0, this._viewEndIndex, function (levelIdx, groupIdx, start, end, hidden) {
...
//# sourceMappingURL=SheetGeometry.js.map