...
L.CanvasTileLayer.include({
    ...
    _addMoveMarker: function () {
        var x = parseInt(this._currentTableData.rectangle.x);
        var y = parseInt(this._currentTableData.rectangle.y);
        var anchorSize = ShapeHandleAnchorSubSection.tableAnchorIconSize;
    ...
    _addSelectionMarkers: function (type, positions, start, end) {
        ...
        for (var i = 0; i < positions.length - 1; i++) {
            if (type === 'column') {
                ...
                startY = start;
                endY = end;
                point1 = this._twipsToLatLng(new L.Point(startX, startY - delta1 - selectionMarkerNominalSize), this._map.getZoom());
                ...
                point1 = this._twipsToLatLng(new L.Point(startX - delta1 - selectionMarkerNominalSize, startY), this._map.getZoom());
...
//# sourceMappingURL=TileLayer.TableOverlay.js.map