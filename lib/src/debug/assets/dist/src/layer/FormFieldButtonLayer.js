...
L.FormFieldButton = L.Layer.extend({
    ...
    _calculateButtonArea: function (map) {
        ...
        var buttonAreaLatLng = new L.LatLngBounds(map._docLayer._twipsToLatLng(buttonAreaTwips[0], this._map.getZoom()), map._docLayer._twipsToLatLng(buttonAreaTwips[1], this._map.getZoom()));
        var buttonAreaLayer = new L.Bounds(map.latLngToLayerPoint(buttonAreaLatLng.getNorthWest()), map.latLngToLayerPoint(buttonAreaLatLng.getSouthEast()));
...
//# sourceMappingURL=FormFieldButtonLayer.js.map