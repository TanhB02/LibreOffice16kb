...
var CanvasSectionContainer = /** @class */ (function () {
    function CanvasSectionContainer(canvasDOMElement, disableDrawing) {
        ...
        */
        ...
        this.clearColor = '#f8f9fa';
        this.documentBackgroundColor = '#ffffff'; // This is the background color of the document
        this.useCSSForBackgroundColor = true;
        ...
        this.framesRendered = 0; // Total frame count for debugging
        // For window sections.
    ...
    CanvasSectionContainer.prototype.getLastPanDirection = function () {
        var dx = this.documentTopLeft[0] - this.lastDocumentTopLeft[0];
        var dy = this.documentTopLeft[1] - this.lastDocumentTopLeft[1];
        return [Math.sign(dx), Math.sign(dy)];
    };
    CanvasSectionContainer.prototype.setBackgroundColorMode = function (useCSSVars) {
        if (useCSSVars === void 0) { useCSSVars = true; }
    ...
    CanvasSectionContainer.prototype.setDocumentBackgroundColor = function (color) {
        this.documentBackgroundColor = color;
    };
    CanvasSectionContainer.prototype.getDocumentBackgroundColor = function () {
        return this.documentBackgroundColor;
    };
    CanvasSectionContainer.prototype.getCanvasStyle = function () {
    ...
    */
    ...
    CanvasSectionContainer.prototype.getDocumentAnchor = function () {
        return [this.documentAnchor[0], this.documentAnchor[1]];
    };
    CanvasSectionContainer.prototype.getCanvasBoundingClientRect = function () {
        return this.canvas.getBoundingClientRect();
    };
    CanvasSectionContainer.prototype.getWidth = function () {
        return this.width;
    };
    CanvasSectionContainer.prototype.getHeight = function () {
        return this.height;
    };
    CanvasSectionContainer.prototype.isDraggingSomething = function () {
        return this.draggingSomething;
    };
    CanvasSectionContainer.prototype.getDragDistance = function () {
        return __spreadArray([], __read(this.dragDistance), false);
    };
    CanvasSectionContainer.prototype.getPositionOnMouseUp = function () {
        return __spreadArray([], __read(this.positionOnMouseUp), false);
    };
    ...
    CanvasSectionContainer.prototype.setDocumentBounds = function (points) {
        var x = Math.round(points[0]);
        var y = Math.round(points[1]);
        ...
        for (var i = 0; i < this.sections.length; i++) {
            ...
            if (section.documentObject === true) {
                ...
                var isVisible = this.isDocumentObjectVisible(section);
    ...
    CanvasSectionContainer.prototype.flushLayoutingTasks = function () {
        var layoutingService = app.layoutingService;
        if (layoutingService.hasTasksPending())
            layoutingService.cancelFrame();
        while (layoutingService.runTheTopTask())
            ;
    };
    CanvasSectionContainer.prototype.redrawCallback = function (timestamp) {
        this.drawRequest = null;
        this.drawSections();
    ...
    CanvasSectionContainer.prototype.propagateCursorPositionChanged = function () {
    ...
    CanvasSectionContainer.prototype.propagateCellAddressChanged = function () {
    ...
    CanvasSectionContainer.prototype.propagateOnContextMenu = function (section, e) {
        this.targetSection = section.name;
        var propagate = true;
        for (var j = 0; j < this.windowSectionList.length; j++) {
            var windowSection = this.windowSectionList[j];
    ...
    */
    CanvasSectionContainer.prototype.onCursorPositionChanged = function () {
    ...
    /*
        ...
        This is for Calc.
    */
    CanvasSectionContainer.prototype.onCellAddressChanged = function () {
    ...
    CanvasSectionContainer.prototype.isLongPressActive = function () {
        return !!this.longPressTimer;
    };
    CanvasSectionContainer.prototype.startLongPress = function (e) {
        this.stopLongPress();
    ...
    CanvasSectionContainer.prototype.stopLongPress = function () {
    ...
    CanvasSectionContainer.prototype.extendAnimationDuration = function (extendMs) {
        if (this.getAnimatingSectionName()) { // Is animating.
            this.duration += extendMs;
        }
    };
    CanvasSectionContainer.prototype.getAnimationDuration = function () {
        return this.duration;
    };
    CanvasSectionContainer.prototype.getScrollLineHeight = function () {
    ...
    CanvasSectionContainer.prototype.onTouchMove = function (e) {
        ...
        if (!this.multiTouch) {
            this.mousePosition = this.convertPositionToCanvasLocale(e);
            this.dragDistance = [this.mousePosition[0] - this.positionOnMouseDown[0], this.mousePosition[1] - this.positionOnMouseDown[1]];
            if (Math.pow(this.dragDistance[0], 2) + Math.pow(this.dragDistance[1], 2) > 0.1)
                this.draggingSomething = true;
            var section = this.getSectionWithName(this.sectionOnMouseDown);
            if (section) {
                this.propagateOnMouseMove(section, this.convertPositionToSectionLocale(section, this.mousePosition), this.dragDistance, e);
    ...
    CanvasSectionContainer.prototype.findSectionContainingPoint = function (point, interactable) {
        if (interactable === void 0) { interactable = true; }
        for (var i = this.sections.length - 1; i > -1; i--) { // Search from top to bottom. Top section will be sent as target section.
            if (this.sections[i].isLocated && !this.sections[i].windowSection &&
    ...
    CanvasSectionContainer.prototype.locateSections = function () {
        for (var i = 0; i < this.sections.length; i++) {
            ...
            if (typeof section.origSizeHint === 'undefined') {
                section.origSizeHint = __spreadArray([], __read(section.size), false);
            }
        }
        this.documentAnchor = null;
        this.windowSectionList = [];
    ...
    CanvasSectionContainer.prototype.shouldDrawSection = function (section) {
    ...
    CanvasSectionContainer.prototype.addSectionFunctions = function (section) {
        ...
        section.startAnimating = function (options) { return this.containerObject.startAnimating(this.name, options); }.bind(section);
        ...
        section.setPosition = function (x, y) {
            ...
            y = Math.round(y);
            var sectionXcoord = x;
            var positionAddition = this.containerObject.getDocumentTopLeft();
            if (this.isCalcRTL()) {
            ...
            this.position[1] = y;
            var isVisible = this.containerObject.isDocumentObjectVisible(this);
        ...
        section.setShowSection = function (show) {
...
//# sourceMappingURL=CanvasSectionContainer.js.map