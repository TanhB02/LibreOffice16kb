...
var NotebookbarAccessibilityDefinitions = function () {
    ...
    this.optionsToolButtons = function (selectedDefinitions) {
        ...
        var optionsToolSectionData = app.map.uiManager.notebookbar.getDefaultToolItems();
        var language = this.getLanguage();
        for (var option = 0; option < optionsToolSectionData.length; option++) {
            var toolOption = optionsToolSectionData[option];
...
//# sourceMappingURL=NotebookbarAccessibilityDefinitions.js.map