    ...
    _onMove: function (e) {
        ...
        if (this._map) {
            ...
            if (e.currentTarget && e.currentTarget.frameElement
                ...
                var rect = this._map._container.getBoundingClientRect(), correction = new L.Point(rect.left, rect.top);
        ...
        if (window.touch.isTouchEvent(e) && Math.abs(offset.x) + Math.abs(offset.y) < 3 && !e.autoscroll) {
            return;
        }
