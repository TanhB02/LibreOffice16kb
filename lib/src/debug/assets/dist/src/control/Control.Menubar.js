...
var Menubar = /** @class */ (function (_super) {
    ...
    function Menubar() {
        ...
        _this.options = {
            ...
            text: [
                ...
                { name: _UNO('.uno:HelpMenu', 'text'), id: 'help', type: 'menu', menu: [
                        ...
                        { name: _('About'), id: 'about', type: 'action', mobileapp: false }
                    ]
                },
            ...
            allowedViewModeActions: [
                function () { return app.sectionContainer.getSectionWithName(L.CSections.CommentList.name).hasAnyComments() ? 'savecomments' : undefined; },
                'shareas',
                'print', 'print-active-sheet', 'print-all-sheets', 'print-notespages',
                'downloadas-odt', 'downloadas-doc', 'downloadas-docx', 'downloadas-rtf',
                'downloadas-odp', 'downloadas-ppt', 'downloadas-pptx', 'downloadas-odg', 'exportpdf',
                !window.ThisIsAMobileApp ? 'exportdirectpdf' : 'downloadas-pdf', !window.ThisIsAMobileApp ? 'exportepub' : 'downloadas-epub',
                'downloadas-ods', 'downloadas-xls', 'downloadas-xlsx', 'downloadas-csv', 'closedocument',
                function () { return !(L.Browser.ie || L.Browser.edge) ? 'fullscreen' : undefined; }, 'zoomin', 'zoomout', 'zoomreset', 'showstatusbar', 'showresolved', 'showannotations', 'toggledarktheme',
                'insert-signatureline',
                'about', 'keyboard-shortcuts', 'latestupdates', 'feedback', 'serveraudit', 'online-help', 'report-an-issue',
                'insertcomment'
            ]
        };
        // Private properties
        ...
        _this._hiddenItems = [];
        _this._menubarCont = null;
        _this._isFileODF = true;
        _this.lastModIndicator = null;
        return _this;
    }
    /**
     ...
     */
    Menubar.prototype.onAdd = function (map) {
     ...
     */
    Menubar.prototype.onRemove = function () {
        var _a;
        ...
        (_a = this._menubarCont) === null || _a === void 0 ? void 0 : _a.remove();
     ...
     */
    Menubar.prototype._addMenu = function (e) {
        var _a;
        ...
        aItem.tabIndex = 0;
        (_a = this._menubarCont) === null || _a === void 0 ? void 0 : _a.insertBefore(liItem, this._menubarCont.firstChild);
    };
    /**
       ...
       */
    Menubar.prototype._createUnoMenuItem = function (caption, command, tag) {
        var liItem, aItem;
     ...
     * @returns The created list item element.
     */
    Menubar.prototype._createActionMenuItem = function (caption, id) {
        var liItem, aItem;
        liItem = L.DomUtil.create('li', '');
        liItem.setAttribute('role', 'menuitem');
        aItem = L.DomUtil.create('a', '', liItem);
     ...
     */
    Menubar.prototype._onInitLanguagesMenu = function () {
    ...
    /**
       ...
       */
    Menubar.prototype._addTabIndexPropsToMainMenu = function () {
     ...
     */
    Menubar.prototype._onRefresh = function () {
        var _a;
        ...
        (_a = document.getElementById('main-menu')) === null || _a === void 0 ? void 0 : _a.setAttribute('role', 'menubar');
     ...
     */
    Menubar.prototype._bindEventIfNotBound = function (element, eventType, namespace, data, handler) {
        var _this = this;
        var eventName = eventType + (namespace ? '.' + namespace : '');
        $(element).off(eventName).on(eventName, data, function (e, menu) { return handler.call(_this, e, menu); });
    };
    /**
     * Handles style changes for the menu based on UNO command state.
     * @param e - The event containing command state data.
     */
    Menubar.prototype._onStyleMenu = function (e) {
     ...
     */
    Menubar.prototype._createDocument = function (e) {
    ...
    /**
       ...
       */
    Menubar.prototype._onDocLayerInit = function () {
        var _this = this;
        this._onRefresh();
        // Usage
        ...
        $(function () {
            ...
            if ($mainMenuState.length) {
                // animate mobile menu
                $mainMenuState.change(function (event) {
                    ...
                    if (event.target.checked) {
                        if (!window.mode.isMobile()) {
                            ...
                            var menuData = _this._map.menubar.generateFullMenuStructure();
                            _this._map.fire('mobilewizard', { data: menuData });
    ...
    /**
       ...
       */
    Menubar.prototype._onClicked = function (e, menu) {
    ...
    /**
       ...
       */
    Menubar.prototype._checkedMenu = function (uno, item) {
    ...
    /**
       ...
       */
    Menubar.prototype._beforeShow = function (e, menu) {
        var _this = this;
        ...
        $(items).each(function (index, aItem) {
            ...
            if (_this._map.isEditMode()) {
                if (type === 'unocommand') { // enable all depending on stored commandStates
                    ...
                    var itemState = _this._map[constState].getItemValue(unoCommand);
                    ...
                    if (unoCommand.startsWith(constLanguage)) {
                        ...
                        languageAndCode = _this._map[constState].getItemValue(unoCommand);
                        ...
                        _this._checkedMenu(unoCommand, _this);
                    }
                    ...
                    if (_this.options.math.includes(unoCommand) && app.map.context.context !== 'Math') {
                        $(aItem).addClass('disabled');
                    }
                }
                    ...
                    if (id === 'fullscreen') { // Full screen works weirdly on IE 11 and on Edge
                        ...
                        else if (_this._map.uiManager.isFullscreen()) {
                            $(aItem).addClass(constChecked);
                        }
                        else {
                            $(aItem).removeClass(constChecked);
                        ...
                        if (_this._map.uiManager.isRulerVisible()) {
                            $(aItem).addClass(constChecked);
                        }
                        else {
                            $(aItem).removeClass(constChecked);
                        ...
                        if (_this._map.uiManager.isStatusBarVisible()) {
                            $(aItem).addClass(constChecked);
                        }
                        else {
                            $(aItem).removeClass(constChecked);
                        ...
                        if (_this._map.uiManager.shouldUseNotebookbarMode()) {
                        ...
                        if (!app.impress.isSlideHidden(_this._map.getCurrentPartNumber()))
                            $(aItem).hide();
                        else
                            $(aItem).show();
                    }
                    ...
                    else if (_this._map.getDocType() === 'presentation' && (id === 'deletepage' || id === 'insertpage' || id === 'duplicatepage')) {
                        if (id === 'deletepage') {
                            itemState = _this._map['stateChangeHandler'].getItemValue('.uno:DeletePage');
                        }
                        else if (id === 'insertpage') {
                            itemState = _this._map['stateChangeHandler'].getItemValue('.uno:InsertPage');
                        }
                        else {
                            itemState = _this._map['stateChangeHandler'].getItemValue('.uno:DuplicatePage');
                        }
                        if (itemState === 'disabled') {
                            $(aItem).addClass('disabled');
                        }
                        ...
                        if (section) {
                            itemState = _this._map['stateChangeHandler'].getItemValue('showannotations');
                            if (itemState === 'true')
                                $(aItem).addClass(constChecked);
                            else
                                $(aItem).removeClass(constChecked);
                        ...
                        itemState = _this._map['stateChangeHandler'].getItemValue(command);
                        if (itemState === 'disabled') {
                            $(aItem).addClass('disabled');
                        }
                        else {
                    ...
                    else if (id === 'serveraudit' && (app.isAdminUser === false || !_this._map.serverAuditDialog)) {
                ...
                if (id && id.indexOf('zotero') >= 0) {
                    if (window.zoteroEnabled && _this._map.zotero)
                        $(aItem).show();
                    else
                        $(aItem).hide();
                }
                ...
                if (type === 'unocommand') { // disable all uno commands
                    ...
                    var allowed = _this.options.allowedViewModeCommands.includes(uno);
                    if (!allowed) {
                        $(aItem).addClass('disabled');
                    ...
                    var found = false;
                    for (var i in _this.options.allowedViewModeActions) {
                        var action = _this.options.allowedViewModeActions[i];
                    ...
                    if (id === 'insertcomment' && (_this._map.getDocType() !== 'drawing' && !app.isCommentEditingAllowed()))
                        found = false;
                    if (id === 'serveraudit' && (app.isAdminUser === false || !_this._map.serverAuditDialog))
                        found = false;
                    if (!found) {
                        $(aItem).hide();
                    }
            ...
            if (id === 'remotelink') {
                if (_this._map['wopi'].EnableRemoteLinkPicker)
                    $(aItem).show();
                else
                    $(aItem).hide();
            }
            if (id === 'remoteaicontent') {
                if (_this._map['wopi'].EnableRemoteAIContent)
                    $(aItem).show();
                else
                    $(aItem).hide();
            }
    ...
    /**
       ...
       */
    Menubar.prototype._openInsertShapesWizard = function () {
     ...
     */
    Menubar.prototype._executeAction = function (itNode, itWizard) {
        var id, postmessage, type;
        if (itNode === undefined) { // called from JSDialogBuilder
            id = itWizard.id;
            postmessage = false;
        }
        else { // called from
        ...
        if (id === 'save') {
            ...
            if (this._map.eSignature) {
                ...
                var finishMessage = _('The signature line can now be moved or resized as needed.');
                var finishFunc = function () { return app.map.eSignature.insert(); };
     ...
     * @param item - The menu item element.
     */
    Menubar.prototype._sendCommand = function (item) {
     ...
     */
    Menubar.prototype._onItemSelected = function (e, item) {
     ...
     */
    Menubar.prototype._onKeyDown = function (e, self) {
        // handle help - F1
     ...
     */
    Menubar.prototype._createFileIcon = function () {
        var liItem = L.DomUtil.create('li', '');
    ...
    /**
       ...
       */
    Menubar.prototype._checkItemVisibility = function (menuItem) {
        ...
        if (menuItem.id && menuItem.id.startsWith('downloadas-')) {
            ...
            var docType = this._map.getDocType();
            var extraFormats = docType === 'presentation' ? ['swf', 'svg', 'bmp', 'gif', 'png', 'tiff']
                : [];
            var appNames = {
     ...
     */
    Menubar.prototype._createMenu = function (menu) {
        var itemList = [];
        var docType = this._map.getDocType();
    ...
    /**
       ...
       */
    Menubar.prototype._getItems = function () {
        if (this._menubarCont == null)
            return null;
        var $cont = $(this._menubarCont);
     ...
     */
    Menubar.prototype._getItem = function (targetId) {
        var items = this._getItems();
        if (items == null)
            return null;
        var found = $(items).filter(function (_, item) {
            var id = $(item).attr('id');
     ...
     */
    Menubar.prototype.hasItem = function (targetId) {
    ...
    /**
       ...
       * @param targetId - The target menu item ID.
       */
    Menubar.prototype.hideItem = function (targetId) {
     ...
     * @param targetId - The target menu item ID.
     */
    Menubar.prototype.showItem = function (targetId) {
        var item = this._getItem(targetId);
        if (item) {
            if ($.inArray(targetId, this._hiddenItems) !== -1)
     ...
     */
    Menubar.prototype._getItemsForCommand = function (commandId) {
        var items = this._getItems();
        if (items == null)
            return null;
     ...
     */
    Menubar.prototype.hideUnoItem = function (targetId) {
        var _this = this;
        var items = this._getItemsForCommand(targetId);
        if (items) {
            $(items).each(function (_, item) {
                if ($.inArray(item.id, _this._hiddenItems) == -1) {
                    _this._hiddenItems.push(item.id);
                }
            });
     ...
     * @param targetId - The UNO command.
     */
    Menubar.prototype.showUnoItem = function (targetId) {
        var _this = this;
        var items = this._getItemsForCommand(targetId);
        if (items) {
            $(items).each(function (_, item) {
                if ($.inArray(item.id, _this._hiddenItems) !== -1) {
                    _this._hiddenItems.splice(_this._hiddenItems.indexOf(item.id), 1);
                }
            });
            $(items).css('display', '');
            return true;
     ...
     * @param menu - Array of menu configuration objects.
     */
    Menubar.prototype._initializeMenu = function (menu) {
        var _a;
        this._isFileODF = app.LOUtil.isFileODF(this._map);
        var menuHtml = this._createMenu(menu);
        for (var i in menuHtml) {
            (_a = this._menubarCont) === null || _a === void 0 ? void 0 : _a.appendChild(menuHtml[i]);
        }
    };
    /**
       ...
       */
    Menubar.prototype.generateFullMenuStructure = function () {
        var topMenu = {
            type: 'menubar',
            enabled: true,
            id: 'menubar',
        ...
        var docType = ('mobile' + this._map.getDocType()); // FIXME There should be a better structure for 'mobile<something>' in the options
     ...
     */
    Menubar.prototype.generateInsertMenuStructure = function () {
        var docType = this._map.getDocType();
        var target = this.options['mobileInsertMenu'][docType];
    ...
    /**
       ...
       */
    Menubar.prototype._generateMenuStructure = function (item, docType, mainMenu) {
        var itemType;
        if (mainMenu) {
            itemType = 'mainmenu';
        }
     ...
     */
    Menubar.prototype._findSubMenuByName = function (menuTarget, nameString) {
     ...
     */
    Menubar.prototype._onInitModificationIndicator = function (lastmodtime) {
    ...
    /**
       ...
       */
    Menubar.prototype._onUpdateModificationIndicator = function (e) {
...
L.control.menubar = function () {
    return new Menubar();
};
//# sourceMappingURL=Control.Menubar.js.map