...
var PresentationBar = /** @class */ (function () {
    function PresentationBar(map) {
        this.map = map;
    ...
    PresentationBar.prototype.create = function () {
    ...
    PresentationBar.prototype.enableItem = function (command, enable) {
        this.builder.executeAction(this.parentContainer, {
            'control_id': command,
            'action_type': enable ? 'enable' : 'disable'
        });
    };
    PresentationBar.prototype.showItem = function (command, show) {
        this.builder.executeAction(this.parentContainer, {
            'control_id': command,
            'action_type': show ? 'show' : 'hide'
        });
    };
    PresentationBar.prototype.uncheck = function () {
        // TODO
    };
    PresentationBar.prototype.show = function () {
        this.parentContainer.style.display = 'grid';
    };
    PresentationBar.prototype._getItemUnoName = function (id) {
    ...
    PresentationBar.prototype.onWopiProps = function (e) {
        if (e.HideExportOption) {
            this.showItem('presentation', false);
        }
    };
    PresentationBar.prototype.onDocLayerInit = function () {
    ...
    PresentationBar.prototype.onUpdatePermission = function (e) {
        var _this = this;
        var presentationButtons = ['insertpage', 'duplicatepage', 'deletepage'];
        if (e.detail.perm === 'edit') {
            presentationButtons.forEach(function (id) { _this.enableItem(id, true); });
            presentationButtons.forEach(function (id) {
                if (id === 'deletepage') {
                    var itemState = _this.map['stateChangeHandler'].getItemValue('.uno:DeletePage');
                }
                else if (id === 'insertpage') {
                    itemState = _this.map['stateChangeHandler'].getItemValue('.uno:InsertPage');
                }
                else if (id === 'duplicatepage') {
                    itemState = _this.map['stateChangeHandler'].getItemValue('.uno:DuplicatePage');
                }
                else {
                    itemState = 'enabled';
                }
                if (itemState === 'enabled') {
                    _this.enableItem(id, true);
                }
                else {
                    _this.enableItem(id, false);
                }
            });
        }
        else {
            presentationButtons.forEach(function (id) { _this.enableItem(id, false); });
        }
    };
    PresentationBar.prototype.onCommandStateChanged = function (e) {
    ...
    PresentationBar.prototype.onSlideHideToggle = function () {
        if (this.map.getDocType() !== 'presentation')
            return;
...
//# sourceMappingURL=Control.PresentationBar.js.map