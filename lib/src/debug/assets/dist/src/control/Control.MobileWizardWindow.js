...
L.Control.MobileWizardWindow = L.Control.extend({
    ...
    _createScrollIndicator: function () {
    ...
    goLevelDown: function (contentToShow, options) {
        ...
        var currentScroll = this.mobileWizard.scrollTop();
    ...
    goLevelUp: function () {
        ...
        if (this._inMainMenu || (this._isTabMode && this._currentDepth == 1
            ...
            var prevScroll = this.scrollPositions.pop();
    ...
    _modifySidebarLayout: function (data) {
        ...
        if (deck) {
            ...
            if (stylesIdx >= 0 && this.map.getDocType() === 'spreadsheet') { // remove rather useless calc styles panel
...
//# sourceMappingURL=Control.MobileWizardWindow.js.map