...
var TopToolbar = /** @class */ (function (_super) {
    __extends(TopToolbar, _super);
    function TopToolbar(map) {
        var _this = _super.call(this, map, 'toolbar-up') || this;
        _this.stylesSelectValue = null;
        map.on('doclayerinit', _this.onDocLayerInit, _this);
        _this.onUpdatePermission = _this.onUpdatePermission.bind(_this);
        app.events.on('updatepermission', _this.onUpdatePermission);
        map.on('wopiprops', _this.onWopiProps, _this);
        ...
        if (!window.mode.isMobile()) {
            map.on('updatetoolbarcommandvalues', _this.updateCommandValues, _this);
        }
        return _this;
    }
    TopToolbar.prototype.onRemove = function () {
    ...
    TopToolbar.prototype.reset = function () {
    ...
    TopToolbar.prototype.callback = function (objectType, eventType, object, data, builder) {
    ...
    TopToolbar.prototype.onStyleSelect = function (e) {
    ...
    TopToolbar.prototype.onContextChange = function (event) {
    ...
    TopToolbar.prototype.getToolItems = function () {
        var items = [
        ...
        this.customItems.forEach(function (customButton) {
            var found = items.find(function (item) {
                return item.id.toLowerCase() === customButton.beforeId.toLowerCase();
            });
            var position = items.indexOf(found);
            customButton.items.forEach(function (item) {
                items.splice(position, 0, item);
            });
        });
        return items;
    };
    TopToolbar.prototype.updateControlsState = function () {
    ...
    TopToolbar.prototype.create = function () {
        this.reset();
    ...
    TopToolbar.prototype.onDocLayerInit = function () {
        var _this = this;
    ...
    TopToolbar.prototype.onUpdatePermission = function (e) {
    ...
    TopToolbar.prototype.onWopiProps = function (e) {
        if (e.HideSaveOption) {
    ...
    TopToolbar.prototype.updateCommandValues = function (e) {
        var data = [];
        var commandValues;
    ...
    TopToolbar.prototype.processStateChangedCommand = function (commandName, state) {
        var found = false;
    ...
    TopToolbar.prototype.onCommandStateChanged = function (e) {
...
//# sourceMappingURL=Control.TopToolbar.js.map