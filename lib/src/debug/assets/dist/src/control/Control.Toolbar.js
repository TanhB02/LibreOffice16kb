...
(function (global) {
    ...
    function getBorderStyleMenuElements(closeCallback) {
        ...
        for (var i = 0; i < 12; i++) {
            ...
            var _loop_1 = function (j) {
                ...
                var num = String(i + j + 1);
                td_1.className = 'w2ui-tb-image w2ui-icon ' + (i + j < 9 ? 'frame0' + String(i + j + 1) : 'frame' + String(i + j + 1));
                td_1.onclick = function () { setBorderStyle(parseInt(num)); };
            };
            for (var j = 0; j < 4; j++) {
                _loop_1(j);
            }
    ...
    function insertTable(grid) {
        if (grid === void 0) { grid = document.getElementsByClassName('inserttable-grid')[0]; }
        var rows = 10;
        var cols = 10;
    ...
    function insertShapes(shapeType, grid, width) {
        if (grid === void 0) { grid = document.getElementsByClassName('insertshape-grid')[0]; }
    ...
    function setupToolbar(e) {
        ...
        $('#closebutton').click(function () {
            var dispatcher = global.app.dispatcher;
            if (!dispatcher)
...
//# sourceMappingURL=Control.Toolbar.js.map