    ...
    _onError: function (e) {
        ...
        if (e.msg) {
            if (window.ThisIsAMobileApp && this._map._fatal) {
                ...
                this._map.uiManager.showConfirmModal('cool_alert', '', e.msg, _('Close'), function () { }, true);
        }
            ...
            this._map.uiManager.showInfoModal('openlink', _('External link'), messageText, url, isLinkValid ? _('Open link') : _('OK'), function () {
                if (!isLinkValid)
                    return;
            ...
            this._map.uiManager.showInfoModal('cool_alert', '', 'This dialog is non-async', '', _('Close'), function () { }, false);
        }
...
//# sourceMappingURL=Control.AlertDialog.js.map