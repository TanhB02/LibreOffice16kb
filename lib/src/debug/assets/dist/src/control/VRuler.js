...
var VRuler = /** @class */ (function (_super) {
    __extends(VRuler, _super);
    function VRuler(map, options) {
    ...
    VRuler.prototype.onAdd = function () {
        ...
        this._map.on('resettopbottompagespacing', this._resetTopBottomPageSpacing, this);
    ...
    VRuler.prototype.onRemove = function () {
    ...
    VRuler.prototype._changeInteractions = function (e) {
    ...
    VRuler.prototype._initiateIndentationMarkers = function () {
    ...
    VRuler.prototype._initLayout = function () {
    ...
    VRuler.prototype._onRulerChanged = function () {
    ...
    VRuler.prototype._updateOptions = function (obj) {
    ...
    VRuler.prototype._updateParagraphIndentations = function () {
    ...
    VRuler.prototype._updateBreakPoints = function () {
        if (this.options.margin1 == null || this.options.margin2 == null)
            return;
        var topMargin = this.options.leftOffset;
        ...
        var bottomMargin = this.options.pageWidth - (this.options.leftOffset + this.options.margin2);
        this.options.pageBottomMargin = bottomMargin;
        var scale = this._map.getZoomScale(this._map.getZoom(), 10);
        var wPixel = docLayer._docPixelSize.y / docLayer._pages -
        ...
        this._rBPContainer.style.marginLeft =
            -1 * (this.options.DraggableConvertRatio * (500 - (topMargin % 1000))) +
                1 +
                'px';
        var numCounter = -1 * Math.floor(topMargin / 1000);
    ...
    VRuler.prototype._fixOffset = function () {
        ...
        var rulerOffset = -app.file.viewedRectangle.cY1 +
            this.options.tileMargin * app.getScale() +
            pageoffset;
        this._rFace.style.marginInlineStart = rulerOffset + 'px';
        this._updateParagraphIndentations();
    };
    VRuler.prototype._moveIndentation = function (e) {
        if (e.type === 'panmove') {
    ...
    VRuler.prototype._moveIndentationEnd = function (e) {
        ...
        var halfWidth = (element.getBoundingClientRect().bottom -
            element.getBoundingClientRect().top) *
            0.5;
        var params = {};
        var upperMargin = 'Space.Upper';
        var lowerMargin = 'Space.Lower';
        if (this._pVerticalStartMarker.getBoundingClientRect().top >
            ...
            var topMarginPX = this._pVerticalStartMarker.getBoundingClientRect().top -
                this._rTSContainer.getBoundingClientRect().top +
                halfWidth;
            var top_1 = topMarginPX / this.options.DraggableConvertRatio +
                this.options.pageTopMargin;
            // margin should not go above page top
            this.options.pageTopMargin = top_1 < 0 ? this.options.pageTopMargin : top_1;
        }
        else if (element.id == 'lo-vertical-pend-marker') {
            var bottomMarginPX = this._rTSContainer.getBoundingClientRect().bottom -
                this._pVerticalEndMarker.getBoundingClientRect().bottom +
                halfWidth;
            var bottom = bottomMarginPX / this.options.DraggableConvertRatio +
    ...
    VRuler.prototype._initiateIndentationDrag = function (e) {
...
//# sourceMappingURL=VRuler.js.map