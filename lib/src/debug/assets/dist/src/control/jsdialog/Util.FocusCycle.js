...
function isFocusable(element) {
    ...
    return focusableElements.some(function (selector) { return element.matches(selector); });
}
...
function findFocusableElement(element, direction) {
    ...
    var focusableInSibling = findFocusableWithin(element, direction);
    if (focusableInSibling)
        return focusableInSibling;
...
//# sourceMappingURL=Util.FocusCycle.js.map