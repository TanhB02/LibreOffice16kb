...
function _setSelection(cursorLayer, text, startX, endX, startY, endY) {
    ...
    for (var i in text) {
        ...
        if (i < startY) {
            ...
            _appendText(newCursorLayer, line.substr(startX, startY == endY ? endX - startX : undefined), ((startX != endX || startY != endY) ? 'selection' : ''));
            if (startY == endY) {
                if (!reversedSelection)
...
//# sourceMappingURL=Widget.FormulabarEdit.js.map