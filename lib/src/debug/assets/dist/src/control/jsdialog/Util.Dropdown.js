        ...
        return function (objectType, eventType, object, data) {
            ...
            if (eventType === 'selected' || eventType === 'showsubmenu') {
                if (entry.items) {
                    ...
                    JSDialog.OpenDropdown(subMenuId, targetEntry, entry.items, generateCallback(entry.items), 'top-end', true);
...
//# sourceMappingURL=Util.Dropdown.js.map