 ...
 */
var JSDialogMessageRouter = /** @class */ (function () {
    function JSDialogMessageRouter() {
    }
    // show labels instead of editable fields in message boxes
    JSDialogMessageRouter.prototype._preProcessMessageDialog = function (msgData) {
    ...
    JSDialogMessageRouter.prototype.processMessage = function (msgData, callbackFn) {
        ...
        if (msgData.action) {
            ...
            var isNotebookbarInitialized = app.socket._map.uiManager && app.socket._map.uiManager.notebookbar;
        ...
        if (window.mode.isMobile()) {
            ...
            if (msgData.enabled ||
                ...
                console.warn('jsdialog: unhandled jsdialog mobile message: {jsontype: "' +
                    msgData.jsontype +
                    '", type: "' +
                    msgData.type +
                    '" ... }');
            ...
            console.warn('Unhandled jsdialog message: {jsontype: "' +
                msgData.jsontype +
                '", type: "' +
                msgData.type +
                '" ... }');
    ...
    return JSDialogMessageRouter;
}());
JSDialog.MessageRouter = new JSDialogMessageRouter();
//# sourceMappingURL=Util.MessageRouter.js.map