...
L.Control.MobileWizard = L.Control.extend({
    ...
    _updateToolbarItemStateByClose: function () {
        var mobileWizard = document.getElementById('mobile_wizard');
        if (window.mobileWizard === false && mobileWizard && mobileWizard.classList.contains('selected'))
            mobileWizard.classList.remove('selected');
        var insertionMobileWizard = document.getElementById('insertion_mobile_wizard');
        ...
        var commentWizard = document.getElementById('comment_wizard');
...
//# sourceMappingURL=Control.MobileWizard.js.map