...
L.Control.Tabs = L.Control.extend({
    ...
    _renameSheet: function () {
        ...
        this._map.uiManager.showInputModal('rename-calc-sheet', _('Rename sheet'), _('Enter new sheet name'), tabName, _('OK'), function (value) {
...
//# sourceMappingURL=Control.Tabs.js.map