...
var HRuler = /** @class */ (function (_super) {
    __extends(HRuler, _super);
    function HRuler(map, options) {
        var _this = _super.call(this, options) || this;
        _this._map = map;
        Object.assign(_this.options, options);
        _this.onAdd(); // VRuler created
        return _this;
    }
    HRuler.prototype.onAdd = function () {
    ...
    HRuler.prototype.onRemove = function () {
    ...
    HRuler.prototype._initiateIndentationMarkers = function () {
    ...
    HRuler.prototype._initLayout = function () {
    ...
    HRuler.prototype._updateOptions = function (obj) {
    ...
    HRuler.prototype._updateParagraphIndentations = function () {
        ...
        var navigationsidebarWidth = app.showNavigator
            ? this._getNavigationSidebarWidth()
            : 0;
        // rTSContainer is the reference element.
        var pStartPosition = this._rTSContainer.getBoundingClientRect().left +
            this.options.leftParagraphIndent -
            navigationsidebarWidth;
        var fLinePosition = pStartPosition + this.options.firstLineIndent;
        var pEndPosition = this._rTSContainer.getBoundingClientRect().right -
            this.options.rightParagraphIndent -
            navigationsidebarWidth;
    ...
    HRuler.prototype._updateTabStops = function (obj) {
        var e_1, _a;
        this.options.tabs = [];
        ...
        if (typeof jsonTabstops === 'string' || jsonTabstops.length === 0)
            return;
        try {
            for (var jsonTabstops_1 = __values(jsonTabstops), jsonTabstops_1_1 = jsonTabstops_1.next(); !jsonTabstops_1_1.done; jsonTabstops_1_1 = jsonTabstops_1.next()) {
                var jsonTabstop = jsonTabstops_1_1.value;
            ...
            try {
                if (jsonTabstops_1_1 && !jsonTabstops_1_1.done && (_a = jsonTabstops_1.return)) _a.call(jsonTabstops_1);
            }
            finally { if (e_1) throw e_1.error; }
        }
    };
    HRuler.prototype._updateBreakPoints = function () {
    ...
    HRuler.prototype._fixOffset = function () {
        if (!this._map.options.docBounds)
            return;
        var rulerOffset = -app.file.viewedRectangle.cX1 + this.options.tileMargin * app.getScale();
        this._rFace.style.marginInlineStart = rulerOffset + 'px';
        this._updateParagraphIndentations();
    };
    HRuler.prototype._moveIndentation = function (e) {
        if (e.type === 'panmove') {
        ...
        var newLeft = parseInt(element.style.left.replace('px', '')) +
            e.clientX -
            this._lastposition;
        element.style.left = String(newLeft) + 'px';
        this._lastposition = e.clientX;
        // halfWidth..
        var halfWidth = (element.getBoundingClientRect().right -
            element.getBoundingClientRect().left) *
            0.5;
        this._markerVerticalLine.style.left = String(newLeft + halfWidth) + 'px';
    };
    HRuler.prototype._moveIndentationEnd = function (e) {
    ...
    HRuler.prototype._initiateIndentationDrag = function (e) {
        if (this.getWindowProperty('ThisIsTheiOSApp') &&
    ...
    HRuler.prototype._initiateDrag = function (e) {
    ...
    HRuler.prototype._moveMargin = function (e) {
        if (e.type === 'touchmove')
            e.clientX = e.touches[0].clientX;
        this._lastposition = e.clientX;
        ...
        if (L.DomUtil.hasClass(this._rMarginDrag, 'leaflet-drag-moving')) {
            ...
            this._rToolTip.innerText =
                (Math.round(this.options.pageWidth / 100 -
                    newPos / (this.options.DraggableConvertRatio * 100)) / 10).toString() + unit;
            ...
            this._lToolTip.innerText =
                (Math.round(newPos / (this.options.DraggableConvertRatio * 100)) / 10).toString() + unit;
            this._lMarginDrag.style.width = newPos + 'px';
        }
    };
    HRuler.prototype._endDrag = function (e) {
        this._map.rulerActive = false;
        var posChange;
        if (e.type === 'touchend')
    ...
    HRuler.prototype._getTabStopHit = function (tabstopContainer, pointX) {
        var tabstop = null;
        var margin = 10;
        ...
        for (var i = 0; i < tabstopContainer.tabStops.length; i++) {
            ...
            var location_1 = current.tabStopLocation;
            if (pointX >= location_1.left - margin &&
                pointX <= location_1.right + margin) {
                var diff = Math.abs(pointX - location_1.center);
    ...
    HRuler.prototype._showTabstopContextMenu = function (position, tabstopNumber) {
    ...
    HRuler.prototype._initiateTabstopDrag = function (event) {
    ...
    HRuler.prototype._moveTabstop = function (event) {
        var tabstopContainer = null;
        var pointX = null;
    ...
    HRuler.prototype._endTabstopDrag = function (event) {
    ...
    HRuler.prototype._onTabstopContainerLongPress = function (event) {
    ...
    HRuler.prototype._deleteTabstop = function () {
    ...
    HRuler.prototype._insertTabstop = function () {
    ...
    HRuler.prototype._getNavigationSidebarWidth = function () {
        // Consider navigations sidebar width to place marker at correct position
        var presentationControlsWrapper = document.querySelector('#navigation-sidebar');
...
//# sourceMappingURL=HRuler.js.map