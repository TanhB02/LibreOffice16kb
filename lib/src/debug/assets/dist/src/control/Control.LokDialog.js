...
L.Control.LokDialog = L.Control.extend({
    ...
    _launchDialog: function (id, leftTwips, topTwips, width, height, title, type, uniqueId) {
        ...
        if (leftTwips != null && topTwips != null) {
            ...
            if (left >= 0 && top >= 0) {
                $(dialogContainer).dialog('option', 'position', { my: 'left top',
    ...
    _paintDialogChild: function (parentId, img) {
        ...
        this._setCanvasWidthHeight(canvas, this._dialogs[parentId].childwidth, this._dialogs[parentId].childheight);
        var ctx = canvas.getContext('2d');
...
//# sourceMappingURL=Control.LokDialog.js.map