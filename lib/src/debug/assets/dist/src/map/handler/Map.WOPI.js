...
L.Map.WOPI = L.Handler.extend({
        ...
        if (!window.ThisIsAMobileApp) {
            ...
            window.open = function (open) {
                return function (url, name, features) {
                    var eSignature = that._map.eSignature;
                    var eSignInProgress = eSignature && eSignature.signInProgress;
                    if (eSignInProgress) {
    ...
    _allowMessageOrigin: function (e) {
        ...
        var eSignature = this._map.eSignature;
    ...
    _postMessageListener: function (e) {
        ...
        if (msg.MessageId === 'Show_Button' || msg.MessageId === 'Hide_Button' || msg.MessageId === 'Remove_Button') {
            ...
            var show_1 = msg.MessageId === 'Show_NotebookTab';
            this._map.uiManager.showNotebookTab(msg.Values.id, show_1);
            return;
        }
...
//# sourceMappingURL=Map.WOPI.js.map