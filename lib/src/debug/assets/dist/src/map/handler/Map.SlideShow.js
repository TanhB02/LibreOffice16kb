...
L.Map.SlideShow = L.Handler.extend({
    ...
    _onFullScreen: function (e) {
        ...
        if (app.impress.areAllSlidesHidden()) {
            this._map.uiManager.showInfoModal('allslidehidden-modal', _('Empty Slide Show'), 'All slides are hidden!', '', _('OK'), function () { }, false, 'allslidehidden-modal-response');
            return;
        }
        var doPresentation = function (that, e) {
        ...
        if (!(this._cypressSVGPresentationTest || this._map['wopi'].DownloadAsPostMessage)) {
            ...
            if (this._slideShow.requestFullscreen) {
                ...
                this._slideShow.requestFullscreen()
                    .then(function () { doPresentation(that_1, e); })
                    .catch(function () {
                    fallback(that_1, e);
                });
                return;
    ...
    _startPlaying: function () {
        ...
        if (this._presentInWindow) {
            ...
            var iFrame = this._slideShowWindowProxy.document.createElement('iframe');
            ...
            this._map.uiManager.showSnackbar(_('Presenting in window'), _('Close Presentation'), function () { slideShowWindow.close(); }, -1, false, true);
        ...
        this._map.uiManager.showSnackbar(_('Presenting in fullscreen'), _('End Presentation'), function () { this._stopFullScreen(); }, null, false, true);
...
//# sourceMappingURL=Map.SlideShow.js.map