...
L.Map.Keyboard = L.Handler.extend({
    ...
    _setPanOffset: function (pan) {
        var keys = {}, codes = this.navigationKeyCodes, i, len;
    ...
    _setZoomOffset: function (zoom) {
        var keys = this._zoomKeys = {}, codes = this.navigationKeyCodes, i, len;
        ...
        if (this._map.jsdialog
            ...
            if (!this._map.isReadOnlyMode() && !this._map['wopi'].HideSaveOption) {
                ...
                if (!this._map._disableDefaultAction['UI_Save']) {
                    this._map.save(false /* An explicit save should terminate cell edit */, false /* An explicit save should save it again */);
                }
            }
            ev.preventDefault();
        }
    ...
    _handleKeyEvent: function (ev, keyEventFn) {
        ...
        if (docLayer)
            this._map.userList.followUser(docLayer._viewId, false);
        if (window.KeyboardShortcuts.processEvent(app.UI.language.fromURL, ev)) {
...
//# sourceMappingURL=Map.Keyboard.js.map