...
L.Clipboard = L.Class.extend({
    ...
    isHtmlImage: function (html) {
        var startsWithMeta = html.substring(0, 5) == '<meta';
        if (startsWithMeta) {
            // Ignore leading <meta>.
            var metaEnd = html.indexOf('>');
            if (metaEnd != -1) {
                // Start after '>'.
    ...
    _getStubHtml: function () {
        return this._substProductName(this._originWrapBody('    <p>' + _('To paste outside {productname}, please first click the \'download\' button') + '</p>\n', true));
    },
    // used for DisableCopy mode to fill the clipboard
    _getDisabledCopyStubHtml: function () {
        return this._substProductName(this._originWrapBody('    <p>' + _('Copying from the document disabled') + '</p>\n', true));
    },
    ...
    _doAsyncDownload: function (type, url, optionalFormData, forClipboard, progressFn) {
                    ...
                    case 0:
                        ...
                        return [4 /*yield*/, new Promise(function (resolve, reject) {
                                request.onload = function () {
                                    _this._downloadProgress._onComplete();
                                    if (!forClipboard) {
                                        _this._downloadProgress._onClose();
                                    }
                                ...
                                request.ontimeout = function () {
                                    _this._map.uiManager.showSnackbar(_('warning: copy/paste request timed out'));
                                    _this._downloadProgress._onClose();
                                ...
                                request.upload.addEventListener('progress', function (e) {
                                    if (e.lengthComputable) {
                                        ...
                                        _this._downloadProgress._onUpdateProgress(progress);
                                    }
                                }, false);
    ...
    _dataTransferDownloadAndPasteAsync: function (src, fallbackHtml) {
        return __awaiter(this, void 0, void 0, function () {
            var response, _error_1, formData, commandName, data, _error_2, formData;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 8]);
                        return [4 /*yield*/, this._doAsyncDownload('GET', src, null, false, function (progress) { return progress / 2; })];
                    case 1:
                        response = _a.sent();
                        return [3 /*break*/, 8];
                    case 2:
                    ...
                    case 3:
                        _a.trys.push([3, 5, , 7]);
                        return [4 /*yield*/, this._doAsyncDownload('POST', this.getMetaURL(), formData, false, function (progress) { return 50 + progress / 2; })];
                    case 4:
                        _a.sent();
                        return [3 /*break*/, 7];
                    case 5:
                        _error_2 = _a.sent();
                        return [4 /*yield*/, this.dataTransferToDocumentFallback(null, fallbackHtml)];
                    case 6:
                        _a.sent();
                        return [3 /*break*/, 7];
    ...
    _sendToInternalClipboard: function (content) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, _b, _c, formData;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        if (!window.ThisIsTheiOSApp) return [3 /*break*/, 3];
                        _b = (_a = window.webkit.messageHandlers.clipboard).postMessage;
                        _c = "sendToInternal ";
                        return [4 /*yield*/, content.text()];
                    case 1: return [4 /*yield*/, _b.apply(_a, [_c + (_d.sent())])];
                    case 2:
                        _d.sent(); // no need to base64 in this direction...
                        return [3 /*break*/, 5];
                    case 3:
                        formData = new FormData();
                        formData.append('file', content);
                        return [4 /*yield*/, this._doAsyncDownload('POST', this.getMetaURL(), formData, false, function (progress) { return progress; })];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                            ...
                            for (t = 0; t < types.length; ++t) {
                                ...
                                if (types[t] === 'Files') {
                                    ...
                                    if (files !== null) {
                                        ...
                                        this._asyncReadPasteFile(dataTransfer.items[t].getAsFile());
                                }
                            }
                        ...
                        return [4 /*yield*/, this._sendToInternalClipboard(content)];
                    case 1:
                        _a.sent();
    ...
    _getHtmlForClipboard: function () {
        ...
        if (this._selectionType === 'complex' || GraphicSelection.hasActiveSelection()) {
            ...
            if (this._selectionType === 'text' && this._selectionContent !== '') { // back here again having downloaded it ...
    ...
    _isAnyInputFieldSelected: function (forCopy) {
        if (forCopy === void 0) { forCopy = false; }
    ...
    _navigatorClipboardGetTypeCallback: function (clipboardContent, blob, type) {
        return __awaiter(this, void 0, void 0, function () {
            var text, error_1, image, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (type == 'image/png') {
                    ...
                    case 3:
                        error_1 = _a.sent();
                        window.app.console.log('blob.text() failed: ' + error_1.message);
                        return [2 /*return*/];
                    case 4:
                    ...
                    case 5:
                        _a.trys.push([5, 7, , 8]);
                        return [4 /*yield*/, clipboardContent.getType('image/png')];
                    case 6:
                        image = _a.sent();
                        return [3 /*break*/, 8];
                    case 7:
                        error_2 = _a.sent();
                        window.app.console.log('clipboardContent.getType(image/png) failed: ' + error_2.message);
                        return [2 /*return*/];
                    case 8:
    ...
    _onCommandResult: function (e) {
        if (e.commandName === '.uno:Copy' || e.commandName === '.uno:Cut' || e.commandName === '.uno:CopyHyperlinkLocation' || e.commandName === '.uno:CopySlide') {
            ...
            while (this._commandCompletion.length > 0) {
                var a = this._commandCompletion.shift();
                a.resolve();
            }
        }
    },
    ...
    _parseClipboardFetchResult: function (text, mimetype, shorttype) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = this.parseClipboard;
                        return [4 /*yield*/, text];
                    case 1:
                        content = _a.apply(this, [_b.sent()])[shorttype];
    ...
    _asyncAttemptNavigatorClipboardWrite: function (params) {
        return __awaiter(this, void 0, void 0, function () {
            var command, check_, url_1, text, clipboardItem, clipboard, error_3;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        command = this._unoCommandForCopyCutPaste;
                        check_ = this._sendCommandAndWaitForCompletion(command, params);
                        if (!window.ThisIsTheiOSApp) return [3 /*break*/, 3];
                        return [4 /*yield*/, check_];
                    case 1:
                        ...
                        // fetching it.
                        if ((_a.sent()) === null)
                            return [2 /*return*/]; // Either wrong command or a pending event.
                        return [4 /*yield*/, window.webkit.messageHandlers.clipboard.postMessage("write")];
                    case 2:
                        _a.sent();
                        return [3 /*break*/, 8];
                    case 3:
                        url_1 = this.getMetaURL() + '&MimeType=text/html,text/plain;charset=utf-8';
                        text = (function () { return __awaiter(_this, void 0, void 0, function () {
                            var result;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, check_];
                                    case 1:
                                        if ((_a.sent()) === null)
                    ...
                    case 4:
                        _a.trys.push([4, 6, , 8]);
                        return [4 /*yield*/, clipboard.write([clipboardItem])];
                    case 5:
                        _a.sent();
                        return [3 /*break*/, 8];
                    case 6:
                        ...
                        if (!document.hasFocus()) {
                            window.app.console.warn('navigator.clipboard.write() failed: ' + error_3.message);
                            return [2 /*return*/];
                        }
                        return [4 /*yield*/, check_];
                    case 7:
                        ...
                        window.app.console.error('navigator.clipboard.write() failed: ' + error_3.message);
    ...
    _iOSReadClipboard: function () {
        return __awaiter(this, void 0, void 0, function () {
            var encodedClipboardData, clipboardData, dataByMimeType;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, window.webkit.messageHandlers.clipboard.postMessage('read')];
                    case 1:
                        encodedClipboardData = _a.sent();
                        if (encodedClipboardData === "(internal)") {
                            return [2 /*return*/, null];
                        }
                        clipboardData = Array.from(encodedClipboardData.split(' ')).map(function (encoded) {
                            return (encoded === '(null)' ? '' : window.b64d(encoded));
                        });
                        dataByMimeType = {};
                        if (clipboardData[0]) {
                        ...
                        return [2 /*return*/, [new ClipboardItem(dataByMimeType)]];
                }
            });
        });
    },
    _asyncAttemptNavigatorClipboardRead: function (isSpecial) {
        return __awaiter(this, void 0, void 0, function () {
            var clipboard, clipboardContents, _a, error_4, clipboardContent, blob, error_5, blob, error_6;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        clipboard = navigator.clipboard;
                    ...
                    case 1:
                        _b.trys.push([1, 6, , 7]);
                        if (!window.ThisIsTheiOSApp) return [3 /*break*/, 3];
                        return [4 /*yield*/, this._iOSReadClipboard()];
                    case 2:
                        _a = _b.sent();
                        return [3 /*break*/, 5];
                    case 3: return [4 /*yield*/, clipboard.read()];
                    case 4:
                        _a = _b.sent();
                        _b.label = 5;
                    case 5:
                        clipboardContents = _a;
                        if (clipboardContents === null) {
                            this._doInternalPaste(this._map, false);
                            return [2 /*return*/]; // Internal paste, skip the rest of the browser paste code
                        }
                        return [3 /*break*/, 7];
                    case 6:
                        error_4 = _b.sent();
                        window.app.console.log('navigator.clipboard.read() failed: ' + error_4.message);
                        if (isSpecial) {
                    ...
                    case 7:
                        ...
                        clipboardContent = clipboardContents[0];
                        if (!clipboardContent.types.includes('text/html')) return [3 /*break*/, 12];
                        blob = void 0;
                        _b.label = 8;
                    case 8:
                        _b.trys.push([8, 10, , 11]);
                        return [4 /*yield*/, clipboardContent.getType('text/html')];
                    case 9:
                        blob = _b.sent();
                        return [3 /*break*/, 11];
                    case 10:
                        error_5 = _b.sent();
                        window.app.console.log('clipboardContent.getType(text/html) failed: ' + error_5.message);
                        return [2 /*return*/];
                    case 11:
                        this._navigatorClipboardGetTypeCallback(clipboardContent, blob, 'text/html');
                        return [3 /*break*/, 18];
                    case 12:
                        if (!clipboardContent.types.includes('text/plain')) return [3 /*break*/, 17];
                        blob = void 0;
                        _b.label = 13;
                    case 13:
                        _b.trys.push([13, 15, , 16]);
                        return [4 /*yield*/, clipboardContent.getType('text/plain')];
                    case 14:
                        blob = _b.sent();
                        return [3 /*break*/, 16];
                    case 15:
                        error_6 = _b.sent();
                        window.app.console.log('clipboardContent.getType(text/plain) failed: ' + error_6.message);
                        return [2 /*return*/];
                    case 16:
    ...
    _warnCopyPasteImpl: function (id) {
        ...
        if (!box) {
            setTimeout(function () { _this._warnCopyPasteImpl(id); }, 10);
            return;
        }
        ...
        if (window.mode.isMobile() || window.mode.isTablet()) {
            ...
            var ctrlText = app.util.replaceCtrlAltInMac('Ctrl');
            var p = document.createElement('p');
    ...
    _warnLargeCopyPasteAlreadyStarted: function () {
        ...
        var container = document.getElementById('large copy paste started warning');
    ...
    _openPasteSpecialPopupImpl: function (id) {
        ...
        // TODO: do it JSDialog native...
        if (!box) {
            setTimeout(function () { _this._openPasteSpecialPopupImpl(id); }, 10);
            return;
        }
        var innerDiv = L.DomUtil.create('div', '', null);
        box.insertBefore(innerDiv, box.firstChild);
