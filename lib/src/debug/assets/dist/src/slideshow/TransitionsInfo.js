...
(function (TransitionClass) {
    TransitionClass[TransitionClass["Invalid"] = 0] = "Invalid";
    TransitionClass[TransitionClass["ClipPoligon"] = 1] = "ClipPoligon";
    TransitionClass[TransitionClass["Special"] = 2] = "Special";
})(TransitionClass || (TransitionClass = {}));
var TransitionReverseMethod;
(function (TransitionReverseMethod) {
    TransitionReverseMethod[TransitionReverseMethod["Ignore"] = 0] = "Ignore";
    TransitionReverseMethod[TransitionReverseMethod["SubtractAndInvert"] = 1] = "SubtractAndInvert";
    TransitionReverseMethod[TransitionReverseMethod["Rotate180"] = 2] = "Rotate180";
    TransitionReverseMethod[TransitionReverseMethod["FlipX"] = 3] = "FlipX";
    TransitionReverseMethod[TransitionReverseMethod["FlipY"] = 4] = "FlipY";
})(TransitionReverseMethod || (TransitionReverseMethod = {}));
...
aTransitionInfoTable[TransitionType.BARNDOORWIPE][TransitionSubType.HORIZONTAL] = {
    class: TransitionClass.ClipPoligon,
    rotationAngle: 90.0,
    scaleX: 1.0,
    scaleY: 1.0,
...
aTransitionInfoTable[TransitionType.CHECKERBOARDWIPE][TransitionSubType.ACROSS] = {
    class: TransitionClass.ClipPoligon,
    rotationAngle: 0.0,
    scaleX: 1.0,
    scaleY: 1.0,
...
aTransitionInfoTable[TransitionType.FOURBOXWIPE][TransitionSubType.CORNERSIN] =
    aTransitionInfoTable[TransitionType.FOURBOXWIPE][TransitionSubType.CORNERSOUT] = {
        class: TransitionClass.ClipPoligon,
        rotationAngle: 0.0,
        scaleX: 1.0,
        scaleY: 1.0,
...
aTransitionInfoTable[TransitionType.PINWHEELWIPE][TransitionSubType.ONEBLADE] =
    aTransitionInfoTable[TransitionType.PINWHEELWIPE][TransitionSubType.TWOBLADEVERTICAL] =
        aTransitionInfoTable[TransitionType.PINWHEELWIPE][TransitionSubType.THREEBLADE] =
            aTransitionInfoTable[TransitionType.PINWHEELWIPE][TransitionSubType.FOURBLADE] =
                aTransitionInfoTable[TransitionType.PINWHEELWIPE][TransitionSubType.EIGHTBLADE] =
                    {
                        class: TransitionClass.ClipPoligon,
                        rotationAngle: 0.0,
                        scaleX: 1.0,
...
aTransitionInfoTable[TransitionType.RANDOMBARWIPE][TransitionSubType.HORIZONTAL] = {
    class: TransitionClass.ClipPoligon,
    rotationAngle: 90.0,
    scaleX: 1.0,
    scaleY: 1.0,
...
aTransitionInfoTable[TransitionType.WATERFALLWIPE][TransitionSubType.HORIZONTALLEFT] = {
    class: TransitionClass.ClipPoligon,
    rotationAngle: -90.0,
    scaleX: 1.0,
    scaleY: 1.0,
...
aTransitionInfoTable[TransitionType.WATERFALLWIPE][TransitionSubType.HORIZONTALRIGHT] = {
    class: TransitionClass.ClipPoligon,
    rotationAngle: 90.0,
    scaleX: 1.0,
    scaleY: 1.0,
...
//# sourceMappingURL=TransitionsInfo.js.map