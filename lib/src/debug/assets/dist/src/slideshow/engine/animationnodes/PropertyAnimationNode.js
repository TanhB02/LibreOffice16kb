 ...
 */
var PropertyAnimationNode = /** @class */ (function (_super) {
    __extends(PropertyAnimationNode, _super);
    function PropertyAnimationNode(aNodeInfo, aParentNode, aNodeContext) {
        var _this = _super.call(this, aNodeInfo, aParentNode, aNodeContext) || this;
        _this.sClassName = 'PropertyAnimationNode';
        return _this;
    }
    PropertyAnimationNode.prototype.createActivity = function () {
        ...
        if (!aAnimation) {
            window.app.console.log('PropertyAnimationNode.createActivity: failed to create animation.');
            return null;
        }
...
//# sourceMappingURL=PropertyAnimationNode.js.map